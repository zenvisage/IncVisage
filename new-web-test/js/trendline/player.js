...
function genCharts(output)
{
	...
	if(resetFlag==false)	 
	{
		...
		{
			console.log("sensordata",iteration);
		...
		else
		{
			...
			console.log(yRange.aMin,currAvgMin,yRange.aMax,currAvgMax);
		...
		if(segment != "")
		{
			for(var i=0;i<segment.length;i++)
			{
				...
				if(i==0)
				{
					...
					segmentArr.splice(segment[i].n,1,segObj);
				}
				else
					segmentArr.splice(segment[i].n,0,segObj);
