...
public class DatabaseMetaData {
	 ...
	 public Map<String,ColumnMetadata> trendDimensions= new HashMap<String,ColumnMetadata>();
	 public Map<String,ColumnMetadata> heatDimensions= new HashMap<String,ColumnMetadata>();
	...
	public Map<String, ColumnMetadata> getTrendColumns() {
		return trendDimensions;
	}
	public void setTrendColumns(Map<String, ColumnMetadata> trendDimensions) {
		this.trendDimensions = trendDimensions;
	}
	public Map<String, ColumnMetadata> getHeatColumns() {
		return heatDimensions;
	}
	public void setHeatColumns(Map<String, ColumnMetadata> heatDimensions) {
		this.heatDimensions = heatDimensions;
	}
